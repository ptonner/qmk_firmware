...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    TD(TD_LSFT_CAPS),  KC_LEAD, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RALT, KC_LBRC, KC_RBRC, TD(TD_RSFT_CAPS)
			       ),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, KC_LCBR,  KC_RCBR, KC_PIPE,
